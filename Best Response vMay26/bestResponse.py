# --------------------------------------------
# Begin: Imports and Gurobi Status Utilities
# --------------------------------------------

import pandas as pd
from model_strGEP import model
import numpy as np
# *** Ajuste 2026-05-06: importa constantes de Gurobi para reportar estados legibles.
from gurobipy import GRB


# *** Ajuste 2026-05-06: traduce codigos de estado de Gurobi a texto compacto.
...
# --------------------------------------------
# End: Imports and Gurobi Status Utilities
# --------------------------------------------


# --------------------------------------------
# Begin: Capacity Expansion Result Aggregation
# --------------------------------------------
...
# --------------------------------------------
# End: Capacity Expansion Result Aggregation
# --------------------------------------------


# --------------------------------------------
# Begin: Capacity and Profit Result Aggregation
# --------------------------------------------
...
# --------------------------------------------
# End: Capacity and Profit Result Aggregation
# --------------------------------------------


# --------------------------------------------
# Begin: Consumer Profit Result Aggregation
# --------------------------------------------
...
# --------------------------------------------
# End: Consumer Profit Result Aggregation
# --------------------------------------------


# --------------------------------------------
# Begin: Market Power Index Aggregation
# --------------------------------------------
...
# --------------------------------------------
# End: Market Power Index Aggregation
# --------------------------------------------


# --------------------------------------------
# Begin: Best-Response Algorithm
# --------------------------------------------

def best_response(d,iterations,epsilon):

    # --------------------------------------------
    # Begin: Best-Response Storage Initialization
    # --------------------------------------------
    ...
    # --------------------------------------------
    # End: Best-Response Storage Initialization
    # --------------------------------------------

    # --------------------------------------------
    # Begin: Diagonalization Loop
    # --------------------------------------------

    # Diagonalization algorithm 
    for iTER in range(iterations):

        # *** Ajuste 2026-05-06: reemplaza el encabezado largo por una linea breve.
        print(f"  Iteracion {iTER + 1}")

        for f in d['F'].values.flatten():

            m = model(d,vXi,vXj,f)
            # *** Ajuste 2026-05-06: reporta solo si cada subproblema fue optimo o no.
            print(f"    GenCo {f}: {gurobi_status_name(m['Sol'])}")
        ...
        if wide.shape[0] >= 2:
            ...
            if delta.le(epsilon).all() or iTER == iterations:
                # *** Ajuste 2026-05-06: deja visible la iteracion de convergencia.
    ...
    # --------------------------------------------
    # End: Diagonalization Loop
    # --------------------------------------------

    # --------------------------------------------
    # Begin: Best-Response Output Package
    # --------------------------------------------
...
# --------------------------------------------
# End: Best-Response Output Package
# --------------------------------------------

# --------------------------------------------
# End: Best-Response Algorithm
# --------------------------------------------
