...
import pandas as pd
# *** Ajuste 2026-05-09: usa configuracion centralizada del solver.
from solver_config import build_gurobi_model
...
# --------------------------------------------
# Begin: Perfect Competition Result Aggregation
# --------------------------------------------
...
# --------------------------------------------
# End: Perfect Competition Result Aggregation
# --------------------------------------------


# --------------------------------------------
# Begin: Perfect Competition GEP Model
# --------------------------------------------

def model(d):

    # --------------------------------------------
    # Begin: Model Environment and Data Unpacking
    # --------------------------------------------

    # model definition
    # *** Ajuste 2026-05-09: crea el modelo con parametros reproducibles.
    m = build_gurobi_model("gepResponse")
    ...
    # --------------------------------------------
    # End: Model Environment and Data Unpacking
    # --------------------------------------------

    # --------------------------------------------
    # Begin: Keys or Index Block
    # --------------------------------------------
    ...
    # --------------------------------------------
    # End: Keys or Index Block
    # --------------------------------------------

    # ======================================================================================== #

    #                              Begin: Params definition block
    ...
    #                               Begin: Solution Information Data
...
# --------------------------------------------
# End: Perfect Competition GEP Model
# --------------------------------------------
